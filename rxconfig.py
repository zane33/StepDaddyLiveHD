...
# Parse API_URL to ensure we use the backend port for WebSocket connections
api_url = os.environ.get("API_URL", "http://192.168.4.5:3232")
parsed_url = urlparse(api_url)
# Replace port with backend_port for WebSocket connections
...
config = rx.Config(
    ...
    api_url=ws_url,  # Use backend port for WebSocket connections
